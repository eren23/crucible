"""Token data loading for sharded binary datasets.

Provides sequential shard reading with wrap-around and distributed
per-rank slicing for multi-GPU training.
"""
